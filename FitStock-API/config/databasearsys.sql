-- ============================================================
-- FitStock - Base de Datos Adaptada para Hosting Arsys
-- ============================================================

-- Desactivamos chequeo de llaves foráneas para evitar errores al crear tablas relacionadas
...
-- Rehabilitamos el chequeo de llaves foráneas
